...
#generamos nuestra predicción a partir del conjunto de datos de prueba
clasificador_predicciones <-predict(clasificador_entrenado,ds_prueba)
summary(clasificador_predicciones)

# ahora generamos una matriz de confusión, a traves de la función especializada
# confusionMatriz del paquete caret
# indicamos que la clase prositiva es la que tiene valor 1(macho)

# la matriz de confusión es una tabla que se utiliza para evaluar el rendimiento
# el rendimiento de un algoritmo de clasificación. Esta tabla muestra el número
# de predicciones correctas de cada clases, tanto las reales como estimadas.
# esta es una herramienta de aprendizaje supervisado, que permite vizualizar
# el desempeño de un algoritmo.
